...
export default function IngredientsList({ userRole }) {
  ...
  const [pendingMenuAction, setPendingMenuAction] = useState(null); // 'add' or 'edit'
  const [pendingEditMenu, setPendingEditMenu] = useState(null);
  const MENU_PASSWORD = 'sadesbetbang'; // Change this to your desired password
...
// SUPER COMPREHENSIVE Indonesian bakery vocabulary
const getCategory = (ingredientName) => {
  const name = ingredientName.toLowerCase();
  
  // 🫒 OIL / MINYAK
  if (name.includes('minyak') || name.includes('oil') || 
      name.includes('canola') || name.includes('sayur') || 
      name.includes('vegetable') || name.includes('coconut oil') ||
      name.includes('minyak goreng') || name.includes('minyak kelapa') ||
      name.includes('minyak zaitun') || name.includes('olive oil') ||
      name.includes('minyak jagung') || name.includes('corn oil') ||
      name.includes('minyak wijen') || name.includes('sesame oil') ||
      name.includes('minyak kanola') || name.includes('minyak bunga matahari') ||
      name.includes('sunflower oil') || name.includes('palm oil') ||
      name.includes('minyak sawit') || name.includes('shortening')) 
    return '🫒 Oil';
  
  // 🧈 BUTTER / MENTEGA
  if (name.includes('butter') || name.includes('mentega') || 
      name.includes('margarin') || name.includes('margarine') ||
      name.includes('unsalted butter') || name.includes('mentega tawar') ||
      name.includes('salted butter') || name.includes('mentega asin') ||
      name.includes('wijsman') || name.includes('anchor') ||
      name.includes('blue band') || name.includes('forvita') ||
      name.includes('pastry margarine') || name.includes('margarin pastry') ||
      name.includes('buttercream') || name.includes('mentega putih') ||
      name.includes('ghee') || name.includes('minyak samin') ||
      name.includes('clarified butter')) 
    return '🧈 Butter';
  
  // 🥛 MILK / SUSU
  if (name.includes('susu') || name.includes('milk') || 
      name.includes('fresh milk') || name.includes('susu segar') ||
      name.includes('uht') || name.includes('ultra milk') ||
      name.includes('susu cair') || name.includes('liquid milk') ||
      name.includes('susu bubuk') || name.includes('milk powder') ||
      name.includes('susu skim') || name.includes('skim milk') ||
      name.includes('susu full cream') || name.includes('full cream milk') ||
      name.includes('susu evaporasi') || name.includes('evaporated milk') ||
      name.includes('susu kental manis') || name.includes('condensed milk') ||
      name.includes('skm') || name.includes('kental manis') ||
      name.includes('susu almond') || name.includes('almond milk') ||
      name.includes('susu kedelai') || name.includes('soy milk') ||
      name.includes('susu oat') || name.includes('oat milk') ||
      name.includes('buttermilk') || name.includes('susu asam')) 
    return '🥛 Milk';
  
  // 🥛 CREAM / KRIM
  if (name.includes('cream') || name.includes('krim') || 
      name.includes('whipping cream') || name.includes('krim kocok') ||
      name.includes('heavy cream') || name.includes('krim berat') ||
      name.includes('light cream') || name.includes('krim ringan') ||
      name.includes('double cream') || name.includes('krim ganda') ||
      name.includes('sour cream') || name.includes('krim asam') ||
      name.includes('pastry cream') || name.includes('krim pastry') ||
      name.includes('custard') || name.includes('vla') ||
      name.includes('non-dairy cream') || name.includes('krim nabati') ||
      name.includes('whipped cream') || name.includes('krim kocok jadi') ||
      name.includes('cream cheese') || name.includes('keju krim') ||
      name.includes('mascarpone') || name.includes('marscapone')) 
    return '🥛 Cream';
  
  // 🌾 FLOUR / TEPUNG
  if (name.includes('tepung') || name.includes('flour') || 
      name.includes('terigu') || name.includes('gandum') ||
      name.includes('protein tinggi') || name.includes('high protein') ||
      name.includes('protein sedang') || name.includes('medium protein') ||
      name.includes('protein rendah') || name.includes('low protein') ||
      name.includes('cakra') || name.includes('cakra kembar') ||
      name.includes('segitiga biru') || name.includes('segitiga') ||
      name.includes('kunci biru') || name.includes('lencana merah') ||
      name.includes('tepung roti') || name.includes('bread flour') ||
      name.includes('tepung serbaguna') || name.includes('all purpose flour') ||
      name.includes('tepung kue') || name.includes('cake flour') ||
      name.includes('tepung pastry') || name.includes('pastry flour') ||
      name.includes('tepung gandum utuh') || name.includes('whole wheat flour') ||
      name.includes('tepung beras') || name.includes('rice flour') ||
      name.includes('tepung ketan') || name.includes('glutinous flour') ||
      name.includes('tepung tapioka') || name.includes('tapioca starch') ||
      name.includes('tepung maizena') || name.includes('cornstarch') ||
      name.includes('tepung sagu') || name.includes('sago flour') ||
      name.includes('tepung almond') || name.includes('almond flour') ||
      name.includes('gluten free flour') || name.includes('tepung bebas gluten') ||
      name.includes('self-raising flour') || name.includes('tepung instan') ||
      name.includes('spelt') || name.includes('rye') || name.includes('gandum hitam')) 
    return '🌾 Flour';
  
  // 🍚 SUGAR / GULA
  if (name.includes('gula') || name.includes('sugar') || 
      name.includes('sweetener') || name.includes('pemanis') ||
      name.includes('gula pasir') || name.includes('granulated sugar') ||
      name.includes('gula halus') || name.includes('icing sugar') ||
      name.includes('gula bubuk') || name.includes('powdered sugar') ||
      name.includes('gula kastor') || name.includes('caster sugar') ||
      name.includes('gula merah') || name.includes('brown sugar') ||
      name.includes('gula aren') || name.includes('palm sugar') ||
      name.includes('gula kelapa') || name.includes('coconut sugar') ||
      name.includes('honey') || name.includes('madu') ||
      name.includes('sirup') || name.includes('syrup') ||
      name.includes('maple syrup') || name.includes('sirup maple') ||
      name.includes('corn syrup') || name.includes('sirup jagung') ||
      name.includes('glukosa') || name.includes('glucose') ||
      name.includes('tetes') || name.includes('molasses') ||
      name.includes('sukrosa') || name.includes('sucrose') ||
      name.includes('dekstrosa') || name.includes('dextrose') ||
      name.includes('fruktosa') || name.includes('fructose') ||
      name.includes('gula invers') || name.includes('invert sugar') ||
      name.includes('stevia') || name.includes('splenda')) 
    return '🍚 Sugar';
  
  // 🍯 FILLINGS / ISI
  if (name.includes('jam') || name.includes('selai') || 
      name.includes('curd') || name.includes('lemon curd') ||
      name.includes('pastry cream') || name.includes('krim pastry') ||
      name.includes('custard') || name.includes('vla') ||
      name.includes('puree') || name.includes('pure') ||
      name.includes('compote') || name.includes('kompot') ||
      name.includes('filling') || name.includes('isi') ||
      name.includes('selai stroberi') || name.includes('strawberry jam') ||
      name.includes('selai blueberry') || name.includes('blueberry jam') ||
      name.includes('selai nanas') || name.includes('pineapple jam') ||
      name.includes('selai kacang') || name.includes('peanut butter') ||
      name.includes('nutella') || name.includes('hazelnut spread') ||
      name.includes('coklat oles') || name.includes('chocolate spread') ||
      name.includes('kaya') || name.includes('srikaya') ||
      name.includes('durian') || name.includes('durian filling') ||
      name.includes('ubi ungu') || name.includes('purple yam') ||
      name.includes('taro') || name.includes('talas') ||
      name.includes('kacang hijau') || name.includes('mung bean') ||
      name.includes('kacang merah') || name.includes('red bean') ||
      name.includes('pasta kacang merah') || name.includes('anko')) 
    return '🍯 Fillings';
  
  // ✨ GLAZES / LAPISAN
  if (name.includes('icing') || name.includes('royal icing') || 
      name.includes('glaze') || name.includes('lapisan') ||
      name.includes('fondant') || name.includes('fondan') ||
      name.includes('mirror glaze') || name.includes('glaze cermin') ||
      name.includes('ganache') || name.includes('ganas') ||
      name.includes('buttercream') || name.includes('butter krim') ||
      name.includes('cream cheese frosting') || name.includes('frosting') ||
      name.includes('meringue') || name.includes('meringue buttercream') ||
      name.includes('swiss meringue') || name.includes('italian meringue') ||
      name.includes('glaze coklat') || name.includes('chocolate glaze') ||
      name.includes('glaze buah') || name.includes('fruit glaze') ||
      name.includes('apricot glaze') || name.includes('glaze aprikot') ||
      name.includes('gelatin') || name.includes('gelatine') ||
      name.includes('cake decor') || name.includes('hiasan kue')) 
    return '✨ Glazes';
  
  // ⚗️ LEAVENING / PENGEMBANG
  if (name.includes('ragi') || name.includes('yeast') || 
      name.includes('fermipan') || name.includes('saf') ||
      name.includes('baking powder') || name.includes('baking soda') ||
      name.includes('soda kue') || name.includes('soda api') ||
      name.includes('ammonium bicarbonate') || name.includes('ammonium') ||
      name.includes('sourdough') || name.includes('starter') ||
      name.includes('ragi instan') || name.includes('instant yeast') ||
      name.includes('ragi kering') || name.includes('dry yeast') ||
      name.includes('ragi basah') || name.includes('fresh yeast') ||
      name.includes('ragi roti') || name.includes('bread yeast') ||
      name.includes('saf-instant') || name.includes('mauripan') ||
      name.includes('baking soda') || name.includes('natrium bikarbonat') ||
      name.includes('baking powder double acting') || name.includes('soda kue') ||
      name.includes('cream of tartar') || name.includes('krim tartar')) 
    return '⚗️ Leavening';
  
  // 🍫 CHOCOLATE / COKLAT
  if (name.includes('coklat') || name.includes('chocolate') || 
      name.includes('cocoa') || name.includes('kakao') ||
      name.includes('couverture') || name.includes('couverture') ||
      name.includes('dark chocolate') || name.includes('coklat hitam') ||
      name.includes('milk chocolate') || name.includes('coklat susu') ||
      name.includes('white chocolate') || name.includes('coklat putih') ||
      name.includes('ruby chocolate') || name.includes('coklat ruby') ||
      name.includes('chocolate chip') || name.includes('chocochip') ||
      name.includes('chocolate chunk') || name.includes('coklat batangan') ||
      name.includes('coklat bubuk') || name.includes('cocoa powder') ||
      name.includes('coklat pasta') || name.includes('cocoa paste') ||
      name.includes('coklat butter') || name.includes('cocoa butter') ||
      name.includes('lemak coklat') || name.includes('coklat compound') ||
      name.includes('coklat coin') || name.includes('chocolate coin') ||
      name.includes('coklat butiran') || name.includes('chocolate pearl') ||
      name.includes('coklat decorating') || name.includes('chocolate deco') ||
      name.includes('bubuk kakao') || name.includes('cocoa bubuk') ||
      name.includes('chocolate bar') || name.includes('coklat batang')) 
    return '🍫 Chocolate';
  
  // 🥜 NUTS & DRIED FRUITS / KACANG & BUAH KERING
  if (name.includes('kacang') || name.includes('nut') || 
      name.includes('almond') || name.includes('badam') ||
      name.includes('walnut') || name.includes('kenari') ||
      name.includes('pecan') || name.includes('pekans') ||
      name.includes('cashew') || name.includes('mede') ||
      name.includes('hazelnut') || name.includes('hazel') ||
      name.includes('pistachio') || name.includes('pistasi') ||
      name.includes('macadamia') || name.includes('makadamia') ||
      name.includes('kacang tanah') || name.includes('peanut') ||
      name.includes('kacang almond') || name.includes('almond') ||
      name.includes('kacang kenari') || name.includes('walnut') ||
      name.includes('kacang mede') || name.includes('cashew') ||
      name.includes('kacang hazel') || name.includes('hazelnut') ||
      name.includes('kacang pistachio') || name.includes('pistachio') ||
      name.includes('kismis') || name.includes('raisin') ||
      name.includes('currant') || name.includes('kurent') ||
      name.includes('cranberry') || name.includes('kranberi') ||
      name.includes('blueberry') || name.includes('bluberi') ||
      name.includes('cherry') || name.includes('ceri') ||
      name.includes('aprikot') || name.includes('apricot') ||
      name.includes('prune') || name.includes('plum') ||
      name.includes('dates') || name.includes('kurma') ||
      name.includes('fig') || name.includes('ara') ||
      name.includes('buah kering') || name.includes('dried fruit') ||
      name.includes('coconut') || name.includes('kelapa') ||
      name.includes('kelapa kering') || name.includes('desiccated') ||
      name.includes('coconut flakes') || name.includes('keripik kelapa')) 
    return '🥜 Nuts & Fruits';
  
  // 🌶️ SPICES & FLAVORINGS / BUMBU & PERASA
  if (name.includes('vanilla') || name.includes('vanili') || 
      name.includes('vanilli') || name.includes('vanilla extract') ||
      name.includes('vanili bubuk') || name.includes('vanilla powder') ||
      name.includes('vanilla paste') || name.includes('vanili pasta') ||
      name.includes('cinnamon') || name.includes('kayu manis') ||
      name.includes('cassia') || name.includes('kasia') ||
      name.includes('cinnamon powder') || name.includes('bubuk kayu manis') ||
      name.includes('nutmeg') || name.includes('pala') ||
      name.includes('pala bubuk') || name.includes('nutmeg powder') ||
      name.includes('cardamom') || name.includes('kapulaga') ||
      name.includes('kapulaga bubuk') || name.includes('cardamom powder') ||
      name.includes('clove') || name.includes('cengkeh') ||
      name.includes('cengkeh bubuk') || name.includes('clove powder') ||
      name.includes('ginger') || name.includes('jahe') ||
      name.includes('jahe bubuk') || name.includes('ginger powder') ||
      name.includes('anise') || name.includes('adas') ||
      name.includes('star anise') || name.includes('pekak') ||
      name.includes('fennel') || name.includes('adas manis') ||
      name.includes('salt') || name.includes('garam') ||
      name.includes('garam halus') || name.includes('fine salt') ||
      name.includes('garam kasar') || name.includes('coarse salt') ||
      name.includes('sea salt') || name.includes('garam laut') ||
      name.includes('himayala') || name.includes('himalayan salt') ||
      name.includes('flaky salt') || name.includes('garam flakes') ||
      name.includes('extract') || name.includes('ekstrak') ||
      name.includes('essence') || name.includes('esens') ||
      name.includes('flavor') || name.includes('perasa') ||
      name.includes('pasta') || name.includes('paste') ||
      name.includes('cocoa butter') || name.includes('lemak coklat') ||
      name.includes('coffee') || name.includes('kopi') ||
      name.includes('kopi bubuk') || name.includes('coffee powder') ||
      name.includes('espresso') || name.includes('espresso powder') ||
      name.includes('matcha') || name.includes('matcha bubuk') ||
      name.includes('teh hijau') || name.includes('green tea') ||
      name.includes('lemon zest') || name.includes('kulit lemon') ||
      name.includes('orange zest') || name.includes('kulit jeruk') ||
      name.includes('peppermint') || name.includes('permén') ||
      name.includes('spekuk') || name.includes('speculaas')) 
    return '🌶️ Spices';
  
  // 🥚 EGGS / TELUR
  if (name.includes('telur') || name.includes('egg') || 
      name.includes('yolk') || name.includes('kuning') ||
      name.includes('kuning telur') || name.includes('egg yolk') ||
      name.includes('putih telur') || name.includes('egg white') ||
      name.includes('albumin') || name.includes('albumen') ||
      name.includes('egg powder') || name.includes('telur bubuk') ||
      name.includes('frozen egg') || name.includes('telur beku') ||
      name.includes('liquid egg') || name.includes('telur cair') ||
      name.includes('egg white powder') || name.includes('putih telur bubuk') ||
      name.includes('egg yolk powder') || name.includes('kuning telur bubuk') ||
      name.includes('telur ayam') || name.includes('chicken egg') ||
      name.includes('telur bebek') || name.includes('duck egg') ||
      name.includes('telur puyuh') || name.includes('quail egg')) 
    return '🥚 Eggs';
  
  // 🍎 FRESH FRUITS / BUAH SEGAR
  if (name.includes('buah') || name.includes('fruit') || 
      name.includes('pisang') || name.includes('banana') ||
      name.includes('apel') || name.includes('apple') ||
      name.includes('jeruk') || name.includes('orange') ||
      name.includes('lemon') || name.includes('lemon') ||
      name.includes('limau') || name.includes('lime') ||
      name.includes('strawberry') || name.includes('stroberi') ||
      name.includes('blueberry') || name.includes('bluberi') ||
      name.includes('raspberry') || name.includes('rasberi') ||
      name.includes('blackberry') || name.includes('blackberi') ||
      name.includes('mangga') || name.includes('mango') ||
      name.includes('nanas') || name.includes('pineapple') ||
      name.includes('pepaya') || name.includes('papaya') ||
      name.includes('alpukat') || name.includes('avocado') ||
      name.includes('kelapa') || name.includes('coconut') ||
      name.includes('nangka') || name.includes('jackfruit') ||
      name.includes('durian') || name.includes('durian') ||
      name.includes('rambutan') || name.includes('rambutan') ||
      name.includes('markisa') || name.includes('passion fruit') ||
      name.includes('kiwi') || name.includes('kiwi') ||
      name.includes('anggur') || name.includes('grape') ||
      name.includes('pir') || name.includes('pear') ||
      name.includes('semangka') || name.includes('watermelon') ||
      name.includes('melon') || name.includes('melon')) 
    return '🍎 Fresh Fruits';
  
  // 📦 PACKAGING / KEMASAN
  if (name.includes('box') || name.includes('kotak') || 
      name.includes('bag') || name.includes('kantong') ||
      name.includes('plastic') || name.includes('plastik') ||
      name.includes('wrapper') || name.includes('pembungkus') ||
      name.includes('kemasan') || name.includes('packaging') ||
      name.includes('container') || name.includes('wadah') ||
      name.includes('cup') || name.includes('gelas') ||
      name.includes('lid') || name.includes('tutup') ||
      name.includes('tray') || name.includes('nampan') ||
      name.includes('label') || name.includes('stiker') ||
      name.includes('kertas roti') || name.includes('parchment paper') ||
      name.includes('baking paper') || name.includes('kertas panggang') ||
      name.includes('aluminium foil') || name.includes('alumunium foil') ||
      name.includes('plastic wrap') || name.includes('plastik wrap') ||
      name.includes('cling wrap') || name.includes('plastik bening') ||
      name.includes('cake box') || name.includes('dus kue') ||
      name.includes('cookie box') || name.includes('dus kue kering') ||
      name.includes('cupcake liner') || name.includes('paper cup') ||
      name.includes('kertas kue') || name.includes('baking cup') ||
      name.includes('piping bag') || name.includes('segitiga') ||
      name.includes('piping tip') || name.includes('spuit') ||
      name.includes('decorating tip') || name.includes('tip spuit') ||
      name.includes('cake stand') || name.includes('standing pouch')) 
    return '📦 Packaging';
...
const categories = ['all', ...new Set(ingredients.map(i => getCategory(i.name)))];
  ...
  const transformed = await Promise.all(menuData.map(async (menu) => {
    ...
    return {
      ...
      notes: menu.notes || '', // 👈 Add this line
...
const handleInstallClick = async () => {
  ...
  <div className="p-4 md:p-6 max-w-6xl mx-auto">
      {/* Header with total value - responsive */}
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-6">
        <h1 className="text-2xl md:text-3xl font-bold">🥖 Bakery Management</h1>
...
<div className="md:hidden mb-4">
  ...
  >
    <span className="font-medium text-gray-900">Menu: {activeTab}</span> {/* Made text darker */}
    <span className="text-gray-700">{mobileMenuOpen ? '▲' : '▼'}</span> {/* Made text darker */}
  </button>
  ...
  {mobileMenuOpen && (
    <div className="mt-2 bg-white rounded-lg shadow-lg p-2 border">
      <button
        ...
        className="w-full text-left p-3 hover:bg-gray-50 rounded-lg text-gray-900" /* Added text-gray-900 */
      >
        📦 Inventory
      </button>
      <button
...
<div className="overflow-x-auto pb-2 mb-6 -mx-4 px-4">
  ...
  <div className="flex space-x-2 min-w-max">
    ...
    <button
      ...
      className={`px-4 py-2 whitespace-nowrap ${activeTab === 'inventory' ? 'border-b-2 border-blue-500 text-blue-600' : 'text-gray-600'}`}
    >
      📦 Inventory
    </button>
    <button
      onClick={() => setActiveTab('menu')}
      className={`px-4 py-2 whitespace-nowrap ${activeTab === 'menu' ? 'border-b-2 border-blue-500 text-blue-600' : 'text-gray-600'}`}
    >
      📋 Menu
    </button>
    <button
      onClick={() => setActiveTab('bake')}
      className={`px-4 py-2 whitespace-nowrap ${activeTab === 'bake' ? 'border-b-2 border-blue-500 text-blue-600' : 'text-gray-600'}`}
    >
      🥐 Bake
    </button>
    <button
      onClick={() => setActiveTab('needToBuy')}
      className={`px-4 py-2 whitespace-nowrap ${activeTab === 'needToBuy' ? 'border-b-2 border-blue-500 text-blue-600' : 'text-gray-600'}`}
    >
      🛒 Need to Buy
    </button>
    <button
      onClick={() => setActiveTab('expenses')}
      className={`px-4 py-2 whitespace-nowrap ${activeTab === 'expenses' ? 'border-b-2 border-blue-500 text-blue-600' : 'text-gray-600'}`}
    >
      💰 Expenses
    </button>
    <button
      onClick={() => setActiveTab('spoilage')}
      className={`px-4 py-2 whitespace-nowrap ${activeTab === 'spoilage' ? 'border-b-2 border-blue-500 text-blue-600' : 'text-gray-600'}`}
    >
      🗑️ Spoilage
    </button>
  </div>
          ...
          <div className="flex flex-col sm:flex-row gap-2">
            <button
              onClick={() => {
                ...
                setSpoilageForm({...spoilageForm, ingredientId: item.id});
        ...
        if (item.ingredient_name) {
          ...
          return (
            <div key={`p-${idx}`} className="flex items-center text-sm p-2 bg-gray-50 rounded">
              ...
              <span className="text-gray-700 font-medium">{item.date}:</span> {/* Made darker */}
              <span className="ml-2 text-gray-900">Added {item.quantity} {item.unit} of {item.ingredient_name}</span> {/* Made darkest */}
            </div>
          );
        } else {
          // Spoilage record
          return (
            <div key={`s-${idx}`} className="flex items-center text-sm p-2 bg-gray-50 rounded">
              ...
              <span className="text-gray-700 font-medium">{item.date}:</span> {/* Made darker */}
              <span className="ml-2 text-gray-900">{item.ingredientName} - {item.quantity} {item.unit} ({item.reason})</span> {/* Made darkest */}
            </div>
          );
        }
      })}
    ...
    <div className="space-y-4">
        ...
        >
          ...
          {menuItems.map(item => (
            <option key={item.id} value={item.id} className="text-gray-900">
              {item.name} (Min: {item.minBatch}) {/* REMOVE ANY PRICE HERE */}
            </option>
          ))}
        </select>
      </div>
      ...
      {selectedMenu && (
        <div className="space-y-4">
          ...
          {menuItems.find(m => m.id === parseInt(selectedMenu))?.notes && (
      ...
      {selectedMenu && (
        <div className="bg-gray-50 p-4 rounded-lg">
          ...
          {/* REMOVE ANY PRICE/BATCH DISPLAY HERE IF IT EXISTS */}
...
{expandedMenus[menu.id] && (
  <div className="mt-4 ml-8 space-y-3">
    ...
    {/* Quick Stats - Optional info for admins */}
    {userRole === 'admin' && (
          ...
          <div className="p-4 bg-gray-50 border-b">
            ...
            onClick={() => exportToCSV(
              purchaseRecords.map(record => ({
                ...
                Unit: record.unit,
                Price_Per_Unit: `Rp ${record.price?.toFixed(0) || '0'}`,
                Total_Cost: `Rp ${record.total_cost?.toFixed(0) || '0'}`
              })),
              'expenses_export',
              ['Date', 'Ingredient', 'Quantity', 'Unit', 'Price_Per_Unit', 'Total_Cost']
            )}
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div className="bg-green-50 p-3 rounded-lg">
                ...
                <p className="text-xl font-bold text-green-800">
                  Rp {purchaseRecords.reduce((sum, record) => sum + (record.total_cost || 0), 0).toFixed(0).replace(/\B(?=(\d{3})+(?!\d))/g, ',')}
                </p>
              </div>
              <div className="bg-purple-50 p-3 rounded-lg">
                <p className="text-sm text-purple-600">Average per Purchase</p>
                <p className="text-xl font-bold text-purple-800">
                  Rp {purchaseRecords.length > 0 
                    ? (purchaseRecords.reduce((sum, record) => sum + (record.total_cost || 0), 0) / purchaseRecords.length).toFixed(0).replace(/\B(?=(\d{3})+(?!\d))/g, ',')
                    : '0'}
                </p>
              </div>
            </div>
                  ...
                  .map((record) => (
                    <tr key={record.id} className="hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4 text-gray-900">
                        Rp {record.price?.toFixed(0).replace(/\B(?=(\d{3})+(?!\d))/g, ',')}/{record.unit}
                      </td>
                      <td className="px-6 py-4 font-medium text-green-600">
                        Rp {record.total_cost?.toFixed(0).replace(/\B(?=(\d{3})+(?!\d))/g, ',')}
                      </td>
                    </tr>
                  ))}
              </tbody>
                  ...
                  <tr key={record.id}>
                    ...
                    <td className="px-6 py-4">
                      <span className={`
                        ...
                        ${record.reason === 'spilled' ? 'bg-blue-100 text-blue-800' : ''}
                        ${record.reason === 'burned' ? 'bg-orange-100 text-orange-800' : ''}
                        ${record.reason === 'expired' ? 'bg-yellow-100 text-yellow-800' : ''}
                        ${record.reason === 'broken' ? 'bg-purple-100 text-purple-800' : ''}
                        ${record.reason === 'contaminated' ? 'bg-red-100 text-red-800' : ''}
    ...
    <div className="bg-white p-6 rounded-lg max-w-2xl w-full max-h-[80vh] overflow-y-auto">
      ...
      <div className="bg-yellow-50 p-4 rounded-lg mt-4">
        ...
        <p className="text-xs text-yellow-600 mt-2 text-center">
          Suggested prices based on common markup percentages
        </p>
      </div>
  ...
  <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-[100]">
    <div className="bg-white p-6 rounded-lg max-w-md w-full">
      ...
      <p className="text-gray-600 mb-4">
        Enter password to {pendingMenuAction === 'add' ? 'add new menu item' : 'edit menu item'}:
      </p>
            ...
            onKeyDown={(e) => {
              if (e.key === 'Enter') {
                if (passwordInput === MENU_PASSWORD) {
                  ...
                  if (pendingMenuAction === 'add') {
                    setEditingMenu(null);
                    setMenuForm({ name: '', minBatch: 1, recipe: [] });
                    setShowMenuEditor(true);
                  } else if (pendingMenuAction === 'edit' && pendingEditMenu) {
                    setEditingMenu(pendingEditMenu);
                    setMenuForm({
                      name: pendingEditMenu.name,
                      minBatch: pendingEditMenu.minBatch,
                      recipe: pendingEditMenu.recipe.map(r => ({
          ...
          <div className="bg-white p-6 rounded-lg max-w-md w-full">
            ...
            <div className="space-y-4">
              <div>
                ...
                <div className="flex space-x-2">
                  <input
                    ...
                    value={purchaseData.barcode}
                    onChange={(e) => setPurchaseData({...purchaseData, barcode: e.target.value})}
              ...
              <div>
                ...
                {purchaseData.name && (
                  <div className="mt-2">
                    {ingredients.find(i => i.name === purchaseData.name) ? (
                      <div className="text-green-600 text-sm">✅ Will update existing ingredient</div>
                    ) : (
                      <div className="text-yellow-600 text-sm">🆕 Will add as new ingredient</div>
                    )}
                  </div>
                )}
              </div>
              ...
              <div>
                ...
                <div className="flex space-x-2">
                  ...
                  />
                  <select
                    className="w-24 p-2 border rounded-lg text-gray-900 bg-white"
                ...
                {purchaseData.quantity && purchaseData.unit && purchaseData.unit !== 'g' && purchaseData.unit !== 'ml' && (
                  <div className="text-xs text-blue-600 mt-1">
                    ↪ Will convert to: {
                      purchaseData.unit === 'kg' ? (parseFloat(purchaseData.quantity) * 1000) + ' g' :
                      purchaseData.unit === 'L' ? (parseFloat(purchaseData.quantity) * 1000) + ' ml' :
                ...
                <div className="space-y-2">
                  <div className="flex items-center space-x-2">
                    <input
                      ...
                      id="totalPriceMode"
                      className="rounded"
                      checked={purchaseData.isTotalPrice}
                      onChange={(e) => setPurchaseData({...purchaseData, isTotalPrice: e.target.checked})}
                    />
                    <label htmlFor="totalPriceMode" className="text-sm text-gray-700">
                      I paid total price (not per unit)
                    </label>
                  </div>
                  ...
                  <div className="flex space-x-2">
                    <input
                      ...
                      placeholder={purchaseData.isTotalPrice ? "Total paid amount" : "Price per unit"}
                    />
                    <span className="w-24 p-2 bg-gray-100 rounded-lg text-gray-700 text-center">
                      {purchaseData.isTotalPrice ? 'total' : '/' + (purchaseData.unit || 'unit')}
                    </span>
                  </div>
                  
                  {purchaseData.isTotalPrice && purchaseData.quantity && purchaseData.price && (
                    <div className="bg-blue-50 p-2 rounded-lg text-sm">
                      <span className="text-blue-700">
                        Per unit: Rp {(parseFloat(purchaseData.price) / parseFloat(purchaseData.quantity)).toFixed(0).replace(/\B(?=(\d{3})+(?!\d))/g, ',')} /{purchaseData.unit || 'unit'}
                      </span>
                    </div>
                  )}
                </div>
              ...
              <div>
                ...
                <input
                  type="date"
                  className="w-full p-2 border rounded-lg text-gray-900"
                  value={purchaseData.expDate}
                  onChange={(e) => setPurchaseData({...purchaseData, expDate: e.target.value})}
                />
              </div>
...
{editingMinStock && (
          ...
          <div className="bg-white p-6 rounded-lg max-w-2xl w-full max-h-[80vh] overflow-y-auto">
            ...
            <div className="space-y-4">
              {/* Menu Name */}
                ...
                <div>
                  ...
                  <input
                    ...
                    min="1"
                    className="w-full p-2 border rounded-lg text-gray-900"
                    value={menuForm.minBatch}
                    onChange={(e) => setMenuForm({...menuForm, minBatch: parseInt(e.target.value) || 1})}
                  />
                  <p className="text-xs text-gray-500 mt-1">Minimum quantity that can be baked at once</p>
                </div>

                {/* 👇 ADD THIS NOTES SECTION */}
                <div>
                  ...
                  <textarea
                    ...
                    placeholder="e.g., Temperature: 350°F, Baking time: 12-15 minutes, Special instructions..."
                  />
                  ...
                  {menuForm.recipe.map((item, index) => {
                    ...
                    return (
                      <div key={index} className="flex items-center justify-between bg-gray-50 p-2 rounded-lg">
                        ...
                        <button
                          onClick={() => {
                            const newRecipe = menuForm.recipe.filter((_, i) => i !== index);
                            setMenuForm({...menuForm, recipe: newRecipe});
                          }}
              ...
              <div className="flex space-x-2 pt-4 border-t">
                <button
                  onClick={async () => {
                    if (!menuForm.name || menuForm.recipe.length === 0) {
                      alert('Please enter menu name and at least one ingredient');
                      return;
                    }
  ...
  .update({
    name: menuForm.name,
    min_batch: menuForm.minBatch,
    notes: menuForm.notes // 👈 Add this
  })
  .eq('id', editingMenu.id);
                      ...
                      for (const recipe of menuForm.recipe) {
                        await supabase
                          .from('recipes')
                          .insert([{
